...
1. keep the EH15 assistant read-only while the earlier maturity layers remain governance-first
2. preserve the narrow-record scope so the assistant explains one visible record at a time instead of expanding into broad transactional search
3. treat broader open-ended transactional querying as still deferred beyond the validated EH15.5 baseline
